...
title ORCHA 0.1.0 - Build and Install
...
echo ORCHA 0.1.0 build and install log > "%LOG%"
...
echo.
echo   ============================================================
echo     DONE. ORCHA 0.1.0 is installed.
echo   ============================================================
echo.
...
echo     grey text must read v0.1.0. If it reads something else,
