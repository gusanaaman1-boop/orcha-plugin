...
title ORCHA 0.13.1 - Build and Install
...
echo ORCHA 0.13.1 build and install log > "%LOG%"
...
echo.
echo   ============================================================
echo     DONE. ORCHA 0.13.1 is installed.
echo   ============================================================
echo.
...
echo     grey text must read v0.13.1. If it reads something else,
